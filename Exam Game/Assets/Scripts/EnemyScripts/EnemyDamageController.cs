...
public class EnemyDamageController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag=="swordAttack") {
            ...
            enemy.GetComponent<EnemyMovementController>().TakeDamage(dmg);//insert reference to current player damage here.This is passed to the enemy controller to change hp
        }
        ...
        if (other.tag=="iceAttack") {
            ...
            enemy.GetComponent<EnemyMovementController>().slowed(ps.freezeSlowMultiplier,ps.freezeTime);
        }
